  ...
  return (
    <>
      <div className="w-full">
        <div
          key={item?.id}
          className={`hover:bg-white/10 bg-white border text-sm flex gap-2 items-center pr-2`}
        >
          {pageParam && (
          ...
          <div className="gap-2 px-3 grid grid-cols-12 text-center justify-center items-center w-full ">
            ...
            >
              ...
              {/* tooltip
              {tooltip && tooltipData && (
                <div className="bg-white shadow-best rounded absolute -top-8 left-[110px] w-[450px] min-h-[110px] tooltip z-50">
                  <div className="flex justify-between">
                    <p>Raqami</p>
                    <p>{tooltipData?.clients?.contact_number}</p>
                  </div>
                  <div className="flex justify-between">
                    <p>JSHSHIR</p>
                    <p>{tooltipData?.clients?.tin}</p>
                  </div>
                  <div className="flex justify-between">
                    <p>Manzili</p>
                    <p>{tooltipData?.clients?.address}</p>
                  </div>
                </div>
              )} */}
            </div>
            <div
              ...
              className={`cursor-pointer text-center p-1.5 font-semibold rounded ${item?.paymentMethods?.name_alias === "naqd"
            ...
            <div className="col-span-2 text-red-500 px-4 flex justify-between">
              <p>
                {Math.floor(
            ...
            <div className="col-span-2 px-4 flex justify-between">
              <p>{Number(item?.sumOfpayments)?.brm()}</p>
              <p className="text-[#85bb65] font-bold">
                {Math.floor(
